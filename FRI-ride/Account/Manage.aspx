            ...
            <section id="passwordForm">
                ...
                <asp:PlaceHolder runat="server" ID="changePasswordHolder" Visible="false">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="CarMake" CssClass="col-md-2 control-label">Car Make</asp:Label>
                            <div class="col-md-10">
                                <asp:TextBox runat="server" ID="CarMake" CssClass="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="CarModel" CssClass="col-md-2 control-label">Car Model</asp:Label>
                            <div class="col-md-10">
                                <asp:TextBox runat="server" ID="CarModel" CssClass="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="Reg_No" CssClass="col-md-2 control-label">Registration plate</asp:Label>
                            <div class="col-md-10">
                                <asp:TextBox runat="server" ID="Reg_No" CssClass="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="CarColor" CssClass="col-md-2 control-label">Color</asp:Label>
                            <div class="col-md-10">
                                <asp:TextBox runat="server" ID="CarColor" CssClass="form-control" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <asp:Button runat="server" Text="Join" OnClick="RegisterDriver" CssClass="btn btn-default" />
                            </div>
                        </div>
